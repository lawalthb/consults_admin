                        ...
                        <div id="page-main-content" class="">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="page-data">
                                        <!--PageComponentStart-->
                                        <div class="border-top td-order_id p-2">
                            ...
                            <div class="border-top td-order_status p-2">
                                <div class="row align-items-center">
                                    <div class="col">
                            ...
                            <div class="d-flex q-col-gutter-xs justify-end">
                                <div class="dropdown" >
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php if($can_edit){ ?>
                                        <a class="dropdown-item "   href="<?php print_link("order_tb/edit/$rec_id"); ?>">
                                        <i class="material-icons">edit</i> Edit
                                    </a>
                                    <?php } ?>
                                    <?php if($can_delete){ ?>
                                    <a class="dropdown-item record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" href="<?php print_link("order_tb/delete/$rec_id"); ?>">
