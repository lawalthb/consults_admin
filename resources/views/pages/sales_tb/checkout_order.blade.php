            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class="card-4 page-content" >
                        <!--[form-start]-->
                        <form id="sales_tb-checkout_order-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('sales_tb.checkout_order_store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-user_id-holder" class=" ">
                                                ...
                                                <option value="">Select a value ...</option>
                                                <?php 
                                                    $options = $comp_model->user_id_option_list_2() ?? [];
                                                    foreach($options as $option){
                                                    $value = $option->value;
                                                    $label = $option->label ?? $value;
