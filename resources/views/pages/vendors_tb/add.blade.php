            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-auto " >
                    <div class="row  q-col-gutter-sm q-px-sm" >
                        <div class="col">
                            <div class="h5 font-weight-bold text-primary">Add New Vendors Tb</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class="card-4 page-content" >
                        <!--[form-start]-->
                        <form id="vendors_tb-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('vendors_tb.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-title-holder" class=" ">
                                                <input id="ctrl-title"  value="<?php echo get_value('title') ?>" type="text" placeholder="Enter Title"  required="" name="title"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
