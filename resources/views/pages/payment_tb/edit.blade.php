            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-auto " >
                    <div class="row  q-col-gutter-sm q-px-sm" >
                        <div class="col">
                            <div class="h5 font-weight-bold text-primary">Edit Payment Tb</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class="card-4 page-content" >
                        <div class="row">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("payment_tb/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-amount_in-holder" class=" ">
                                                    <input id="ctrl-amount_in"  value="<?php  echo $data['amount_in']; ?>" type="number" placeholder="Enter Amount In" step="0.1"  required="" name="amount_in"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-amount_out-holder" class=" ">
                                                    <input id="ctrl-amount_out"  value="<?php  echo $data['amount_out']; ?>" type="number" placeholder="Enter Amount Out" step="0.1"  required="" name="amount_out"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-amount_balance-holder" class=" ">
                                                    <input id="ctrl-amount_balance"  value="<?php  echo $data['amount_balance']; ?>" type="number" placeholder="Enter Amount Balance" step="0.1"  required="" name="amount_balance"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-cmment-holder" class=" ">
                                                    <input id="ctrl-cmment"  value="<?php  echo $data['cmment']; ?>" type="text" placeholder="Enter Cmment"  name="cmment"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
