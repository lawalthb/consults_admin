            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class="card-4 page-content" >
                        <!--[form-start]-->
                        <form id="admins_tb-userregister-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('auth.register_store') }}" method="post">
                            <!--[form-content-start]-->
                            @csrf
                            <div>
